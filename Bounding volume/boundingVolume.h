...
typedef struct Volume {
	...
	Volume (Volume v1, Volume v2) {
		...
		support4 = helper_min(v1.support4, v2.support4);
		support5 = helper_min(v1.support5, v2.support5);
		support6 = helper_min(v1.support6, v2.support6);
		support7 = helper_min(v1.support7, v2.support7);
