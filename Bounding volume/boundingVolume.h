...
typedef struct Volume {
	...
	Volume(ArcStruct arc) {
		...
		if (arc.endAngle.quad == 0) {
			...
			cout << "Quad1: " << sAng_r << " ~ " << eAng_r << " ==> " << support0 << ", " << support1 << ", " << support2 << ", " << support4 << ", " << support5 << ", " << support6 << endl;
		}
			...
			cout << "Quad2: " << sAng_r << " ~ " << eAng_r << " ==> " << support0 << ", " << support2 << ", " << support3 << ", " << support4 << ", " << support6 << ", " << support7 << endl;
		}
	...
	Volume (Volume v1, Volume v2) {
		...
		support4 = (v1.support4 > 0 && v2.support4 > 0) ? min(v1.support4, v2.support4) : max(v1.support4, v2.support4);
		support5 = (v1.support5 > 0 && v2.support5 > 0) ? min(v1.support5, v2.support5) : max(v1.support5, v2.support5);
		support6 = (v1.support6 > 0 && v2.support6 > 0) ? min(v1.support6, v2.support6) : max(v1.support6, v2.support6);
		support7 = (v1.support7 > 0 && v2.support7 > 0) ? min(v1.support7, v2.support7) : max(v1.support7, v2.support7);
